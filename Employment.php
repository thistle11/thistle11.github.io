...
<html lang="en">
  ...
  <body>
    ...
    <section class = "projects">
      ...
      <h2>Employment - Canada</h2>    
       
        <!-- Copy the whole <section> block to add more projects. -->
        <section class="project-item">
          <h3>Deaths </h2>
          <p>Death per day by country over time</p>
          <iframe class = "xd" src='https://flo.uri.sh/visualisation/1975350/embed' 
            frameborder='0' scrolling='no' style='width:100%;height:300px;'>
           </iframe>
           <div style='width:100%!;margin-top:4px!important;text-align:right!important;'>
             <a class='flourish-credit' href='https://public.flourish.studio/visualisation/1975350/?utm_source=embed&utm_campaign=visualisation/1975350' 
        ...
        <section class="project-item">
          <h3>Confirmed </h2>
          <p>Confirmed cases per day by country over time</p>
          <iframe class = "xd" src='https://flo.uri.sh/visualisation/1975350/embed' 
            frameborder='0' scrolling='no' style='width:100%;height:300px;'>
           </iframe>
           <div style='width:100%!;margin-top:4px!important;text-align:right!important;'>
        ...
        <section class="project-item">
          <h3>Recovered </h2>
          <p>Recovered cases per day by country over time</p>
           <iframe class = "xd" src='https://flo.uri.sh/visualisation/1975350/embed' 
            frameborder='0' scrolling='no' style='width:100%;height:300px;'>
           </iframe>
           <div style='width:100%!;margin-top:4px!important;text-align:right!important;'>
